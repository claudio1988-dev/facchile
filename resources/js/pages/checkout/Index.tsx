                                    ...
                                    <Card>
                                        ...
                                        <CardContent className="p-0">
                                            {items.length === 0 ? (
                                                ...
                                                <div className="divide-y text-text-main dark:text-white">
                                                    {items.map((item) => (
                                    ...
                                    <Card>
                                        ...
                                        <CardContent className="space-y-4">
                                            ...
                                            >
                                                ...
                                                <div className="flex-1">
                                                    <div className="font-bold text-text-main dark:text-white">Transferencia Bancaria</div>
                            ...
                            <div className="space-y-6">
                                <Card className="sticky top-[180px]">
                                    ...
                                    <CardContent className="space-y-4">
                                        <div className="space-y-2">
                                            <div className="flex justify-between text-sm">
                                                ...
                                                <span className="text-text-main dark:text-white">${total.toLocaleString('es-CL')}</span>
                                            </div>
                                            <div className="flex justify-between text-sm">
                                                <span className="text-muted-foreground">Envío</span>
                                                <span className="text-green-600 font-medium">Por calcular</span>
                                            </div>
                                            <div className="border-t pt-4 flex justify-between font-bold text-xl text-text-main dark:text-white">
                                                <span>Total</span>
                                    ...
                                    <CardFooter className="flex-col gap-4 border-t bg-muted/20">
                                        ...
                                        <div className="flex items-center gap-2 text-[10px] text-muted-foreground uppercase tracking-widest leading-none">
